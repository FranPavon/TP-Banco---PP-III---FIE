...
AppPrincipal::AppPrincipal(wxWindow* parent,wxWindowID id)
{
	...
	StaticBox2 = new wxStaticBox(this, ID_STATICBOX2, _("Cuentas"), wxPoint(568,48), wxSize(456,144), 0, _T("ID_STATICBOX2"));
	...
	ButtonBajaCuenta = new wxButton(this, ID_BUTTONBAJACUENTA, _("Baja"), wxPoint(728,136), wxSize(136,32), 0, wxDefaultValidator, _T("ID_BUTTONBAJACUENTA"));
	...
	ButtonMovimientos = new wxButton(this, ID_BUTTONMOV, _("Movimientos"), wxPoint(864,80), wxSize(136,32), 0, wxDefaultValidator, _T("ID_BUTTONMOV"));
	...
	StaticBoxListados = new wxStaticBox(this, ID_STATICBOX3, _("Listados"), wxPoint(32,216), wxSize(992,136), 0, _T("ID_STATICBOX3"));
	...
	ButtonMov = new wxButton(this, ID_BUTTON4, _("Movimientos"), wxPoint(864,248), wxSize(136,32), 0, wxDefaultValidator, _T("ID_BUTTON4"));
	...
	ButtonCSC = new wxButton(this, ID_BUTTON7, _("Cuentas Saldo 0"), wxPoint(728,296), wxSize(136,32), 0, wxDefaultValidator, _T("ID_BUTTON7"));
...
void AppPrincipal::OnButtonSAcreedorClick(wxCommandEvent& event)
{
    ...
    archT<<left<<setw(15)<<"Nro de Cuenta"<<setw(15)<<"DNI Titular"<<setw(15)<<"Tipo de cuenta"<<setw(15)<<"Saldo"<<endl;
